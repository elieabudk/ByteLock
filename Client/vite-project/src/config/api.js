...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    OBTENER_INGRESOS: '/api/obtener-ingresos',
    OBTENER_EGRESOS: '/api/obtener-egresos',
    ELIMINAR_DATOS_BANCARIOS: '/api/eliminar-datos-bancarios',
...
export const API_URLS = {
  ...
  OBTENER_INGRESOS: buildApiUrl(API_CONFIG.ENDPOINTS.OBTENER_INGRESOS),
  OBTENER_EGRESOS: buildApiUrl(API_CONFIG.ENDPOINTS.OBTENER_EGRESOS),
  ELIMINAR_DATOS_BANCARIOS: buildApiUrl(API_CONFIG.ENDPOINTS.ELIMINAR_DATOS_BANCARIOS),
  ELIMINAR_SUSCRIPCION: buildApiUrl(API_CONFIG.ENDPOINTS.ELIMINAR_SUSCRIPCION)
}; 