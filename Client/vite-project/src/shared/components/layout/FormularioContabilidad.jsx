...
export const FormularioContabilidad = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await FetchPostDatos('/api/guardar-egresos', data);
        ...
        <form ref={formRef} onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
                ...
                <div className="input-group">
                    ...
                    <input type="number" className="form-control" id="monto" name="monto" placeholder="0.00"/>
                </div>
            </div>
